package org.quickat.web.filter;
...
/**
 * Almost the same as com.auth0.spring.security.auth0.Auth0AuthenticationFilter, except that this one does not
 * return 401 for invalid token: it just ignores it.
 *
